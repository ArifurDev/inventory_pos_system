                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    @endif
                                        ...
                                        <form role="form"  action="{{ route('Selary.store') }}" method="POST">
                                            @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control form-white" data-placeholder="Supplier Type" name="email">
                                                            @foreach ($empolyee as $emp_mail)
                                                            <option value="{{ $emp_mail->email }}">{{ $emp_mail->email }}</option>
                                                            @endforeach
                                                         </select>
                                                        </div>
                                                    <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="month" id="bdaymonth" name="salary_date">
                                                    </div>
