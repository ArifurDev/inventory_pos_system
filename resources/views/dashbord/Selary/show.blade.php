                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        @foreach ($selarys as $selary)
                                                            <tr>
                                                                <td>{{ $selary->name }}</td>
                                                                <td>{{ $selary->email }}</td>
                                                                <td>{{ $selary->phone }}</td>
                                                                <td>{{ $selary->selary }} tk</td>
                                                                <td>{{ $selary->advanch }} tk</td>
                                                                <td>{{ $selary->due }} tk</td>
                                                                <td>{{ $selary->salary_date }}</td>
                                                                <td>{{ $selary->status }}</td>
                                                                <td>{{ $selary->created_at }}</td>
                                                                <td>
                                                                        <div class="btn-group btn-group-justified m-b-10">
                                                                            <a href="{{ route('empolyee.Selary.edit',$selary->id) }}" class="btn btn-danger waves-effect waves-light" title="edit" role="button"><i class="md  md-edit"></i></a>
                                                                            <a href="{{ route('empolyee.Selary.destroy',$selary->id) }}" class="btn btn-primary waves-effect waves-light" title="destroy" role="button"><i class="md  md-delete"></i></a>
