                                                    ...
                                                    <tbody>
                                                        @foreach ($product as $product_info)
                                                            <tr>
                                                                ...
                                                                <td style="width:10px">{{ $product_info->supplier_name }}</td>
                                                                <td>{{ $product_info->product_name }}</td>
                                                                <td>
                                                                    <img  style="width: 70px; height: 70px; " src="{{ asset('upload/product_image') }}/{{ $product_info->product_image }}" >
                                                                </td>
                                                                <td>{{ $product_info->product_code }}</td>
                                                                <td>{{ $product_info->product_storehouse }}</td>
                                                                <td>{{ $product_info->product_route }}</td>
                                                                <td>{{ $product_info->seling_price }}tk</td>
                                                                <td>
                                                                        <div class="btn-group btn-group-justified m-b-10">
