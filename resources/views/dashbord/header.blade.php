<meta charset="utf-8">
        ...
        <!-- Font Icons -->
        <link href="{{ asset('dashbord') }}/assets/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
        <link href="{{ asset('dashbord') }}/assets/ionicon/css/ionicons.min.css" rel="stylesheet" />
        <link href="{{ asset('dashbord') }}/css/material-design-iconic-font.min.css" rel="stylesheet">

        <!-- animate css -->
        <link href="{{ asset('dashbord') }}/css/animate.css" rel="stylesheet" />

        <!-- Waves-effect -->
        <link href="{{ asset('dashbord') }}/css/waves-effect.css" rel="stylesheet">
